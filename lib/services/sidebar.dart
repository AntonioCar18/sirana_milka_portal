    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 5),
          sidebarItem(context: context, icon: Icons.list_alt, title: "Narudžbe", index: 4, routeName: '/ogin'),
          const SizedBox(height: 5),
          sidebarItem(context: context, icon: Icons.money, title: "Financije", index: 5, routeName: '/logn'),
          const SizedBox(height: 5),
          sidebarItem(context: context, icon: Icons.logout, title: "Odjava", index: 6, routeName: 'login'),
        ],
      ),
    );
  }
